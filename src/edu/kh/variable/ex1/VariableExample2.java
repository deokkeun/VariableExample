...
public class VariableExample2 {
	public static void main(String[] args) {
		...
		int intNumber = 2183648; // 변수 선언 및 초기화
		// 자료형 변수명 = 리터럴;
		...
		// d를 뒤에 쓸 수는 있다. 3.141592653589793d;
		 ...
		 * 'B' 문자 그대로가 대입되면 변수에는 숫자 66으로 변화되서 저장.
		...
		// 변수 명명 규칙
		// 1.대소문자 구분 0, 길이제한 X
		int asldkfjasodfijasoijegkamsdfglja;
		int asldkfjasodfijasoijegkamsdfgljA;
